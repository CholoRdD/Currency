...
<div class="flex min-h-screen flex-row bg-gradient-to-tr from-black to-green-900">
	<div>
		<Header />
	</div>
	<div
		class="mx-10 my-12 flex h-[85vh] w-[85vw] flex-row rounded-3xl border-2 border-green-700 bg-black bg-opacity-30 p-12"
	>
		<div class="flex flex-row gap-5">
			...
			<Output from={showFrom} to={showTo} amount={showInput} exchange={exchangeOut.toFixed(4)} hide={outputStatus}  />
		</div>
	</div>
</div>
