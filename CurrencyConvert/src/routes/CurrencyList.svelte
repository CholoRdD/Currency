...
<div class="flex flex-row gap-5">
	<div>
		<div
			class="flex flex-col h-12 w-48 flex-wrap items-center justify-center gap-1
	overflow-scroll overflow-x-hidden rounded-t-2xl border-2 border-green-900 bg-transparent text-xl font-bold text-white"
		...
		<input
			...
			class="w-48 border-2 border-green-900 bg-transparent p-2 text-white text-center"
		/>
		<div
			class="flex h-[250px] w-48 flex-wrap items-center justify-center gap-1
	...
	<div>
		<p
			class="flex h-12 w-48 flex-wrap items-center justify-center gap-1
	overflow-scroll overflow-x-hidden rounded-t-2xl border-2 border-green-900 bg-transparent text-xl font-bold text-white"
		>
			TO
		</p>
		...
		>
			{#each filterTo as code}
				<button
					class="h-10 w-full border-blue-800 hover:bg-green-600 hover:font-bold {selectTo === code
						? `bg-green-600 font-bold`
